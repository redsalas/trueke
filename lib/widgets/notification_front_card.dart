...
class NotificationFrontCard extends StatefulWidget {
  ...
  @override
  _NotificationFrontCardState createState() => _NotificationFrontCardState();
}

class _NotificationFrontCardState extends State<NotificationFrontCard> {
