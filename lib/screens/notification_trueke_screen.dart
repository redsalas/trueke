...
import 'package:trueke/tiles/trueke_offert_tile.dart';
...
class NotificationTruekeScreen extends StatefulWidget {
  const NotificationTruekeScreen({Key key}) : super(key: key);

  @override
  _NotificationTruekeScreenState createState() => _NotificationTruekeScreenState();
}

class _NotificationTruekeScreenState extends State<NotificationTruekeScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: FutureBuilder(
              future: getPostByTrueke(settings.userId),
              builder: (context, snapshot) {
                ...
                return snapshot.hasData ? ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    ...
                    return TruekeOffertProductTile(post: Post.fromJson(list[index]));
                  },
